...
IF EXISTS (
		...
		WHERE TABLE_NAME = 'OBSERVATION_ClarityAMB_SNOMED_ICD'
		)
	DROP TABLE OMOP_Clarity.OBSERVATION_ClarityAMB_SNOMED_ICD;;
...
INTO OMOP_Clarity.OBSERVATION_ClarityAMB_SNOMED_ICD
