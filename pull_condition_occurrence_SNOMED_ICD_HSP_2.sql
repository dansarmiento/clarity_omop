...
Name: pull_condition_occurrence_SNOMED_ICD_HSP_2
...
Description: This script is the 1st it a two-part process.  It is used in conjunction with 
	(and before) app_condition_occurrence_SNOMED_ICD_HSP_2. 

	Its purpose is to query data from Epic Clarity and append this data to CONDITION_OCCURRENCE_ClarityHosp_SNOMED_ICD
	which will be used later in app_condition_occurrence_SNOMED_ICD_HSP_2.  The table may have numerous
...
IF EXISTS (	SELECT NULL
			...
			WHERE TABLE_NAME = 'CONDITION_OCCURRENCE_ClarityHosp_SNOMED_ICD')
	DROP TABLE OMOP_Clarity.CONDITION_OCCURRENCE_ClarityHosp_SNOMED_ICD;
...
SELECT DISTINCT  
	...
	--------------------------------------------
	,'pull_CONDITION_OCCURRENCE--ClarityHosp--SNOMED_ICD' AS ETL_Module


INTO OMOP_Clarity.CONDITION_OCCURRENCE_ClarityHosp_SNOMED_ICD
